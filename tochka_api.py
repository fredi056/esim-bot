...
# Current production verification key published in Tochka's official webhook docs.
# The client still refreshes it from the bank first; this is a pinned fallback for
# hosting environments whose TLS chain temporarily prevents that refresh.
TOCHKA_WEBHOOK_JWK = {
    "kty": "RSA",
    "e": "AQAB",
...
class TochkaClient:
    ...
    def _load_public_key(self):
        ...
        try:
            ...
            try:
                key = jwt.PyJWK.from_dict(TOCHKA_WEBHOOK_JWK).key
